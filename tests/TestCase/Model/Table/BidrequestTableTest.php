...
class BidrequestTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Bidrequest') ? [] : ['className' => BidrequestTable::class];
        $this->Bidrequest = TableRegistry::getTableLocator()->get('Bidrequest', $config);
    }
